 ...
 * @link		https://github.com/nobuti/Codeigniter-breadcrumbs
 */
class Breadcrumbs {
     ...
     * @return	string
     */
    function show($crumb_divider = null) {
        if ($crumb_divider === null) {
            $crumb_divider = $this->crumb_divider;
        }
        ...
        if ($this->breadcrumbs) {
            ...
            foreach ($this->breadcrumbs as $key => $crumb) {
                if (end(array_keys($this->breadcrumbs)) == $key) {
                    ...
                    $output .= $this->crumb_open . '<a href="' . $crumb['href'] . '">' . $crumb['page'] . '</a> ' . $crumb_divider . $this->crumb_close;
                }
            }
