...
class Auth extends MY_Controller {
    ...
    function login() {
        if ($this->tank_auth->is_logged_in()) {         // logged in
            ...
            if ($this->form_validation->run()) {        // validation ok
                ...
                if ($this->tank_auth->login($this->form_validation->set_value('login'), $this->form_validation->set_value('password'), $this->form_validation->set_value('remember'), $data['login_by_username'], $data['login_by_email'], $user_type)) {
                    ...
                    $this->message->set('error', implode('<br/>', $data['errors']));
                    redirect('');
                }
            }
    ...
    function ajax_login() {
        ...
        if ($this->form_validation->run()) {        // validation ok
            ...
            if ($this->tank_auth->login($this->form_validation->set_value('login'), $this->form_validation->set_value('password'), $this->form_validation->set_value('remember'), true, true, $user_type)) {
                ...
                foreach ($errors as $k => $v)
                    $data['errors'][$k] = $this->lang->line($v);
                $data['errors_msg'] = implode('<br/>', $data['errors']);
            }
        }
    ...
    function register() {
        if ($this->tank_auth->is_logged_in()) {         // logged in
            ...
            if ($this->form_validation->run()) {
                ...
                $data = $this->tank_auth->create_user($use_username ? $this->form_validation->set_value('username') : '', $this->form_validation->set_value('email'), $this->form_validation->set_value('password'), $email_activation, $extra_data);
